object F_uf: TF_uf
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object PageControle_uf: TPageControl
    Left = 0
    Top = 0
    Width = 613
    Height = 227
    ActivePage = Tab_cadastro_uf
    Align = alClient
    TabOrder = 0
    object Tab_cadastro_uf: TTabSheet
      Caption = 'Cadastro'
      object L_ds_uf: TLabel
        ...
        Height = 13
        Caption = 'UF'
        FocusControl = DBE_ds_uf
      end
      object L_nm_uf: TLabel
        Left = 16
        Top = 56
        Width = 33
        Height = 13
        Caption = 'Estado'
        FocusControl = DBE_nm_uf
      end
      object DBE_ds_uf: TDBEdit
        Left = 16
        Top = 32
        Width = 30
        Height = 21
        DataField = 'DS_UF'
        DataSource = DS_cadastro_uf
        TabOrder = 0
      end
      object DBE_nm_uf: TDBEdit
        Left = 16
        Top = 72
        Width = 524
        Height = 21
    ...
    object Tab_consultta_uf: TTabSheet
      Caption = 'Consulta'
      ImageIndex = 1
      object DBG_consulta_uf: TDBGrid
        Left = 8
        Top = 56
        Width = 585
        Height = 169
  ...
  object DS_cadastro_uf: TDataSource
    DataSet = DataModulo.IBD_uf
    OnStateChange = DS_cadastro_ufStateChange
    Left = 384
    Top = 24
  end
  object DS_consulta_uf: TDataSource
    DataSet = DataModulo.IBQ_uf
    Left = 428
    Top = 24
  end
end
