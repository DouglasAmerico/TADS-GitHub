object F_clientes: TF_clientes
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object PaginaControle_cliente: TPageControl
    Left = 0
    Top = 0
    Width = 1008
    Height = 362
    ActivePage = Tab_cadastro_cliente
    Align = alClient
    TabOrder = 0
    object Tab_cadastro_cliente: TTabSheet
      Caption = 'Cadastro'
      object L_cd_cliente: TLabel
        ...
        Height = 13
        Caption = 'Codigo'
        FocusControl = DBE_cd_cliente
      end
      object L_cd_cidade: TLabel
        Left = 8
        Top = 56
        Width = 33
        Height = 13
      ...
      object L_ds_cliente: TLabel
        Left = 8
        Top = 96
        Width = 32
        Height = 13
        Caption = 'Cliente'
        FocusControl = DBE_ds_cliente
      end
      ...
      object L_ds_endereco: TLabel
        Left = 560
        Top = 24
        Width = 46
        Height = 13
        Caption = 'Endereco'
        FocusControl = DBE_ds_endereco
      end
      object L_nr_endereco: TLabel
        Left = 560
        Top = 72
        Width = 74
        Height = 13
        Caption = 'Num. Endere'#231'o'
        FocusControl = DBE_nr_endereco
      end
      object L_nr_cep: TLabel
        Left = 560
        Top = 112
        Width = 21
        Height = 13
        Caption = 'CEP'
        FocusControl = DBE_nr_cep
      end
      object L_nr_cpf: TLabel
        Left = 560
        Top = 152
        Width = 20
        Height = 13
        Caption = 'CPF'
        FocusControl = DBE_nr_cpf
      end
      object L_nr_cnpj: TLabel
        Left = 560
        Top = 192
        Width = 27
        Height = 13
        Caption = 'CNPJ'
        FocusControl = DBE_nr_cnpj
      end
      object L_regstrar_telefone: TLabel
        Left = 8
        Top = 224
        Width = 304
        Height = 13
        Caption = 
          'Ap'#243's efetuar o cadastro, registre um ou mais telefones ao client' +
          'e'
      end
      object DBE_cd_cliente: TDBEdit
        Left = 8
        Top = 32
        Width = 134
        Height = 21
        DataField = 'CD_CLIENTE'
        DataSource = DS_cadastro_cliente
        Enabled = False
        TabOrder = 0
      end
      object DBE_ds_cliente: TDBEdit
        Left = 8
        Top = 112
        Width = 524
        Height = 21
      ...
      object DBE_ds_endereco: TDBEdit
        Left = 560
        Top = 40
        Width = 524
        Height = 21
      ...
      object DBE_nr_endereco: TDBEdit
        Left = 560
        Top = 88
        Width = 134
        Height = 21
      ...
      object CB_cd_cidade: TDBLookupComboBox
        Left = 8
        Top = 72
        Width = 145
        Height = 21
        ...
        KeyField = 'CD_CIDADE'
        ListField = 'DS_CIDADE'
        ListSource = DS_lista_cidade_cliente
        TabOrder = 13
      end
      object B_registrar_telefone: TButton
        Left = 8
        Top = 248
        Width = 113
        Height = 17
        Caption = 'Cadastro Telefone'
        TabOrder = 14
        OnClick = B_registrar_telefoneClick
      end
    ...
    object Tab_consulta_cliente: TTabSheet
      Caption = 'Consulta'
      ImageIndex = 1
      object DBG_consulta_cliente: TDBGrid
        Left = 8
        Top = 40
        Width = 1265
        Height = 289
        ...
        TitleFont.Style = []
        OnDblClick = DBG_consulta_clienteDblClick
        OnKeyPress = DBG_consulta_clienteKeyPress
        Columns = <
          item
            Expanded = False
          ...
          item
            ...
            Title.Caption = 'Num. Endere'#231'o'
            Visible = True
          end
          item
            Expanded = False
      ...
      object E_pesquisar_cliente: TEdit
        Left = 8
        Top = 8
        Width = 473
        Height = 21
      ...
      object B_pesquisar_cliente: TButton
        Left = 496
        Top = 8
        Width = 73
        Height = 25
        Caption = 'Pesquisar'
        TabOrder = 2
        OnClick = B_pesquisar_clienteClick
      end
    end
  end
  object RD_pesquisa: TRadioGroup
    Left = 608
    Top = 24
    Width = 225
    Height = 33
  ...
  object DS_cadastro_cliente: TDataSource
    DataSet = DataModulo.IBD_cliente
    OnStateChange = DS_cadastro_clienteStateChange
    Left = 1104
    Top = 16
  end
  object DS_lista_cidade_cliente: TDataSource
    DataSet = DataModulo.IBQ_lista_cidade_cliente
    Left = 1144
    Top = 16
  end
  object DS_consulta_cliente: TDataSource
    DataSet = DataModulo.IBQ_cliente
    Left = 1188
    Top = 16
  end
end
