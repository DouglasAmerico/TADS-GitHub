object F_unidade_medida: TF_unidade_medida
  Left = 339
  Top = 320
  Width = 589
  Height = 300
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object PaginaControle_unidade_medida: TPageControl
    Left = 0
    Top = 0
    Width = 573
    Height = 261
    ActivePage = Tab_consulta_unidade_medida
    Align = alClient
    TabOrder = 0
    object Tab_cadastro_unidade_medida: TTabSheet
      Caption = 'Cadastro'
      object L_cd_unidade_medida: TLabel
        ...
        Height = 13
        Caption = 'Codigo'
        FocusControl = DBE_cd_unidade_medida
      end
      object L_ds_unidade_medida: TLabel
        Left = 16
        Top = 48
        Width = 93
        Height = 13
        Caption = 'Unidade de Medida'
        FocusControl = DBE_ds_unidade_medida
      end
      object L_in_situacao: TLabel
        Left = 16
        Top = 88
        Width = 42
        Height = 13
      ...
      object DBE_cd_unidade_medida: TDBEdit
        Left = 16
        Top = 24
        Width = 134
        Height = 21
        DataField = 'CD_UNIDMEDIA'
        DataSource = DS_cadastro_unidade_medida
        Enabled = False
        TabOrder = 0
      end
      object DBE_ds_unidade_medida: TDBEdit
        Left = 16
        Top = 64
        Width = 524
        Height = 21
        DataField = 'DS_UNIDMEDIA'
        DataSource = DS_cadastro_unidade_medida
        TabOrder = 1
      end
      object CB_in_situacao: TDBComboBox
        Left = 16
        Top = 104
        Width = 49
        Height = 21
    ...
    object Tab_consulta_unidade_medida: TTabSheet
      Caption = 'Consulta'
      ImageIndex = 1
      object DBG_consulta_unidade_medida: TDBGrid
        Left = 0
        Top = 56
        Width = 561
        Height = 177
        DataSource = DS_consulta_unidade_medida
        ...
        TitleFont.Style = []
        OnCellClick = DBG_consulta_unidade_medidaCellClick
        Columns = <
          item
            Expanded = False
      ...
      object E_pesquisar_unidade_medida: TEdit
        Left = 0
        Top = 16
        Width = 217
        Height = 21
      ...
      object B_unidade_medida: TButton
        Left = 232
        Top = 16
        Width = 75
        Height = 25
        Caption = 'Pesquisar'
        TabOrder = 2
        OnClick = B_unidade_medidaClick
      end
    end
  end
  object DS_cadastro_unidade_medida: TDataSource
    DataSet = DataModulo.IBD_unidade_medida
    OnStateChange = DS_cadastro_unidade_medidaStateChange
    Left = 440
    Top = 24
  end
  object DS_consulta_unidade_medida: TDataSource
    DataSet = DataModulo.IBQ_unidade_medida
    Left = 492
    Top = 24
  end
end
