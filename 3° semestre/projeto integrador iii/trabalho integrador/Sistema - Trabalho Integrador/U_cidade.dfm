object F_cidade: TF_cidade
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object PaginaControle_cidade: TPageControl
    Left = 0
    Top = 0
    Width = 724
    Height = 292
    ActivePage = Tab_cadastro_cidade
    Align = alClient
    TabOrder = 0
    object Tab_cadastro_cidade: TTabSheet
      Caption = 'Cadastro'
      object L_cd_cidade: TLabel
        ...
        Height = 13
        Caption = 'Codigo'
        FocusControl = DBE_cd_cidade
      end
      object L_ds_uf: TLabel
        Left = 16
        Top = 56
        Width = 14
        Height = 13
      ...
      object L_ds_cidade: TLabel
        Left = 16
        Top = 96
        Width = 33
        Height = 13
        Caption = 'Cidade'
        FocusControl = DBE_ds_cidade
      end
      ...
      object DBE_cd_cidade: TDBEdit
        Left = 16
        Top = 32
        Width = 134
        Height = 21
        DataField = 'CD_CIDADE'
        DataSource = DS_cadastro_cidade
        Enabled = False
        TabOrder = 5
      end
      object DBE_ds_cidade: TDBEdit
        Left = 16
        Top = 112
        Width = 524
        Height = 21
      ...
      object CB_cd_uf: TDBLookupComboBox
        Left = 16
        Top = 72
        Width = 137
        Height = 21
        ...
        KeyField = 'DS_UF'
        ListField = 'NM_UF'
        ListSource = DS_lista_uf_cidade
        TabOrder = 7
      end
    end
    object Tab_consulta_cidae: TTabSheet
      Caption = 'Consulta'
      ImageIndex = 1
      object DBG_consulta_cidade: TDBGrid
        Left = 0
        Top = 40
        Width = 713
        Height = 217
        ...
        TitleFont.Style = []
        OnCellClick = DBG_consulta_cidadeCellClick
        Columns = <
          item
            Expanded = False
            FieldName = 'CD_CIDADE'
      ...
      object E_pesquisar_cidade: TEdit
        Left = 0
        Top = 8
        Width = 337
        Height = 21
      ...
      object B_pesquisar_cidade: TButton
        Left = 344
        Top = 8
        Width = 75
        Height = 25
        Caption = 'Pesquisar'
        TabOrder = 2
        OnClick = B_pesquisar_cidadeClick
      end
      object RD_cidade: TRadioGroup
        Left = 432
        Top = 0
        Width = 185
        Height = 33
  ...
  object DS_cadastro_cidade: TDataSource
    DataSet = DataModulo.IBD_cidade
    OnStateChange = DS_cadastro_cidadeStateChange
    Left = 552
    Top = 192
  end
  object DS_lista_uf_cidade: TDataSource
    DataSet = DataModulo.IBQ_lista_uf_cidade
    Left = 596
    Top = 192
  end
  object DS_consulta_cidade: TDataSource
    DataSet = DataModulo.IBQ_cidade
    Left = 644
    Top = 192
  end
end
