object F_produto: TF_produto
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object PaginaControle_produto: TPageControl
    Left = 0
    Top = 0
    Width = 1008
    Height = 474
    ActivePage = Tab_cadastro_produto
    Align = alClient
    TabOrder = 0
    object Tab_cadastro_produto: TTabSheet
      Caption = 'Cadastro'
      object L_cd_produto: TLabel
        ...
        Height = 13
        Caption = 'Codigo'
        FocusControl = DBE_cd_produto
      end
      object L_cd_unidade_medida: TLabel
        Left = 16
        Top = 72
        Width = 93
        Height = 13
      ...
      object L_qt_estoque: TLabel
        Left = 16
        Top = 176
        Width = 55
        Height = 13
        Caption = 'Quantidade'
        FocusControl = DBE_qt_estoque
      end
      object L_vl_preco: TLabel
        Left = 16
        Top = 224
        Width = 28
        Height = 13
        Caption = 'Pre'#231'o'
        FocusControl = DBE_vl_preco
      end
      object L_qt_estoque_minimo: TLabel
        Left = 16
        Top = 288
        Width = 75
        Height = 13
        Caption = 'Estoque Minimo'
        FocusControl = DBE_qt_estoque_minimo
      end
      object L_selecione_produto: TLabel
        Left = 560
        Top = 16
        Width = 562
        Height = 16
        Caption = 
          'Selecione o Produto caso queira acrecentar quantidades maiores a' +
      ...
      object DBE_cd_produto: TDBEdit
        Left = 16
        Top = 24
        Width = 249
        Height = 21
        DataField = 'CD_PRODUTO'
        DataSource = DS_cadastro_produto
        Enabled = False
        TabOrder = 0
      end
      ...
      object DBE_qt_estoque_minimo: TDBEdit
        Left = 16
        Top = 304
        Width = 249
        Height = 21
      ...
      object Cb_cd_unidade_medida: TDBLookupComboBox
        Left = 16
        Top = 88
        Width = 249
        Height = 21
        DataField = 'CD_UNIDMEDIA'
        DataSource = DS_cadastro_produto
        KeyField = 'CD_UNIDMEDIA'
        ListField = 'DS_UNIDMEDIA'
        ListSource = DS_lista_unidade_medida_produto
        TabOrder = 5
      end
      ...
      object DBG_consula2_produto: TDBGrid
        Left = 560
        Top = 80
        Width = 625
        Height = 265
        ...
        TitleFont.Style = []
        OnCellClick = DBG_consula2_produtoCellClick
        Columns = <
          item
            Expanded = False
      ...
      object B_pesqusa_acressimo: TButton
        Left = 560
        Top = 48
        Width = 625
        Height = 25
        Caption = 'Disparar Pesquisa'
        TabOrder = 12
        OnClick = B_pesqusa_acressimoClick
      end
    end
    object Tab_consulta_produto: TTabSheet
      Caption = 'Consulta'
      ImageIndex = 1
      object DBG_consulta_produto: TDBGrid
        ...
        TitleFont.Name = 'MS Sans Serif'
        TitleFont.Style = []
        OnCellClick = DBG_consulta_produtoCellClick
        Columns = <
          item
            Expanded = False
      ...
      object E_pesquisar_produto: TEdit
        Left = 0
        Top = 24
        Width = 497
        Height = 21
      ...
      object B_pesquisar_produto: TButton
        Left = 512
        Top = 24
        Width = 105
        Height = 25
        Caption = 'Pesquisar'
        TabOrder = 2
        OnClick = B_pesquisar_produtoClick
      end
      object RG_produto: TRadioGroup
        Left = 744
        Top = 0
        Width = 305
        Height = 41
        Caption = 'Selecione Pesquisa:'
        Columns = 3
        ItemIndex = 0
        Items.Strings = (
          'Codigo'
  ...
  object DS_cadastro_produto: TDataSource
    DataSet = DataModulo.IBD_produto
    OnStateChange = DS_cadastro_produtoStateChange
    Left = 216
    Top = 16
  end
  object DS_lista_unidade_medida_produto: TDataSource
    DataSet = DataModulo.IBQ_lista_unidade_medida_produto
    Left = 252
    Top = 16
  end
