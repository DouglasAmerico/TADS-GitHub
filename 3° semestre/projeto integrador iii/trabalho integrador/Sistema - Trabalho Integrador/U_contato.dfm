object F_contato: TF_contato
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object PaginaControle_contato: TPageControl
    Left = 0
    Top = 0
    Width = 1008
    Height = 297
    ActivePage = Tab_cadastro_contato
    Align = alClient
    TabOrder = 0
    object Tab_cadastro_contato: TTabSheet
      Caption = 'Cadastro'
      ...
      object L_nm_contato: TLabel
        Left = 8
        Top = 88
        Width = 37
        Height = 13
        Caption = 'Contato'
        FocusControl = DBE_nm_contato
      end
      object L_ds_email: TLabel
        Left = 8
        Top = 128
        Width = 29
        Height = 13
        Caption = 'E-Mail'
        FocusControl = DBE_ds_email
      end
      object DBE_nr_sequencia: TDBEdit
        ...
        DataSource = DS_cadastro_contato
        Enabled = False
        TabOrder = 0
      end
      object DBE_nm_contato: TDBEdit
        Left = 8
        Top = 104
        Width = 524
        Height = 21
      ...
      object CB_cd_cliente: TDBLookupComboBox
        ...
        ListSource = DS_lista_cliente_contato
        TabOrder = 3
      end
    ...
    object Tab_consulta_contato: TTabSheet
      Caption = 'Consulta'
      ImageIndex = 1
      object DBG_consulta_contato: TDBGrid
        Left = 8
        Top = 48
        Width = 1313
        Height = 209
        DataSource = DS_consulta_contato
        ...
        TitleFont.Style = []
        OnCellClick = DBG_consulta_contatoCellClick
        Columns = <
          item
            Expanded = False
      ...
      object E_pesquisar_contato: TEdit
        Left = 0
        Top = 16
        Width = 393
        Height = 21
      ...
      object B_pesquisar_contato: TButton
        Left = 416
        Top = 16
        Width = 75
        Height = 25
        Caption = 'Pesquisar'
        TabOrder = 2
        OnClick = B_pesquisar_contatoClick
      end
      object RD_contato: TRadioGroup
        Left = 512
        Top = 8
        Width = 281
        Height = 33
  ...
  object DS_cadastro_contato: TDataSource
    DataSet = DataModulo.IBD_contato
    OnStateChange = DS_cadastro_contatoStateChange
    Left = 1184
    Top = 32
  end
  object DS_lista_cliente_contato: TDataSource
    DataSet = DataModulo.IBQ_lista_cliente_contato
    Left = 1228
    Top = 32
  end
  object DS_consulta_contato: TDataSource
    DataSet = DataModulo.IBQ_contato
    Left = 1276
    Top = 32
  end
end
